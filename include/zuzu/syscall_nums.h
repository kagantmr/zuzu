...
#define SYS_NTFN_SIGNAL 0x25 /* (ntfn, bits) -> 0 or -err; bit 31 reserved for errors */
#define SYS_NTFN_WAIT 0x26   /* (ntfn, timeout_ms) -> bits or -err; bit 31 reserved for errors */
#define SYS_STAMP 0x27       /* (handle, value) -> stamped_handle or -err*/
#define SYS_SET_LABEL 0x28   /* (task_handle, value) -> 0 or -err */
...
#define __SYSCALL_RESERVED2 0x33 /* Reserved, used to be shm_attach() */
#define __SYSCALL_RESERVED3 0x34 /* Reserved, used to be mapdev() */
#define __SYSCALL_RESERVED4 0x35 /* Reserved, used to be shm_detach() */
#define __SYSCALL_RESERVED5 0x36 /* Reserved, used to be querydev( )*/
...
#define __SYSCALL_RESERVED6 0x40 /* Reserved, used to be irq_claim */
