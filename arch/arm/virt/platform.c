// platform.c - QEMU `virt` device bring-up (arch_platform_init_devices).
//
...
// UART, a GICv2 interrupt controller ("arm,cortex-a15-gic", same as
// vexpress-a15), a PL031 RTC, and uses the ARM generic timer as its tick
// source. A board with different peripherals (e.g. a non-PL011 UART or
// GICv3) provides its own version of this file.
//
// The compatible-string tables absorb naming differences across closely
// related boards that share these peripherals, but they do not make this
